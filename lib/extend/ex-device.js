 ...
 * @param extraDevice
 */
function addExtend(Nightmare, extraDevice) {
    Nightmare.prototype.exDevice = function (name) {
        var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

        // 合并传入的自定义设备
        var deviceMap = _lodash2.default.merge({}, DEVICE, extraDevice);
        var that = this;
